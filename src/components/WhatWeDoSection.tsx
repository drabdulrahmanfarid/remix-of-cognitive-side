  ...
  return <section ref={ref} className="py-32 md:py-40 px-6 bg-secondary/30 relative overflow-hidden">
      ...
      <div className="max-w-6xl mx-auto relative z-10">
        ...
        <ul className="grid md:grid-cols-2 lg:grid-cols-4 gap-6 list-none p-0 m-0">
          {services.map((service, index) => <motion.li key={service.title} custom={index} initial="initial" animate={isInView ? "animate" : "initial"} variants={cardVariants} className="relative min-h-[14rem] list-none">
