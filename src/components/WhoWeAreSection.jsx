...
const WhoWeAreSection = () => {
  ...
  return (
    <section ref={ref} id="about" className="py-32 md:py-40 px-6">
      <motion.div
      ...
      >
        ...
        <div className="space-y-6">
          ...
          >
            We design and develop intelligent AI systems that transform business
          ...
          >
            Our focus is not just tools — it's creating AI solutions that
