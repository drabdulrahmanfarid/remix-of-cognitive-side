...
const HeroSection = () => {
  return (
    <section className="relative min-h-screen flex items-center justify-center overflow-hidden">
      ...
      <div className="relative z-10 text-center px-6 max-w-4xl mx-auto">
        <AnimatePresence>
          ...
          <motion.div
            ...
            className="inline-flex items-center gap-2 px-4 py-2 mb-8 rounded-full border border-primary/30 bg-card/50 backdrop-blur-sm"
          >
            <span className="relative flex h-2 w-2">
              <span className="animate-ping absolute inline-flex h-full w-full rounded-full bg-primary opacity-75"></span>
              <span className="relative inline-flex rounded-full h-2 w-2 bg-primary"></span>
            </span>
            <span className="text-sm font-medium text-foreground">30+ Successful Projects Delivered</span>
          </motion.div>
          ...
          <motion.p
            ...
            className="text-7xl sm:text-8xl md:text-9xl font-bold tracking-tight text-foreground mb-6 text-center px-[18px] lg:text-9xl"
          >
            Cognitive Side
          </motion.p>
          ...
          <motion.h1
            ...
            className="text-3xl sm:text-4xl md:text-5xl lg:text-6xl font-semibold tracking-tight text-foreground mb-8 text-center"
          >
          ...
          <motion.p
            ...
            className="text-lg sm:text-xl md:text-2xl max-w-2xl mx-auto mb-6 font-semibold text-foreground"
          >
          ...
          >
            <motion.a
              href="#contact"
              className="group relative inline-flex items-center gap-3 px-8 py-4 text-base font-medium rounded-full border border-primary/30 text-foreground overflow-hidden"
              whileHover={{ borderColor: 'hsl(43 52% 54% / 0.6)' }}
            ...
            >
              ...
              <motion.div
                ...
                style={{ boxShadow: '0 0 30px hsl(43 52% 54% / 0.3)' }}
              />
            </motion.a>
          </motion.div>
        </AnimatePresence>
      ...
      >
        <div className="w-6 h-10 rounded-full border border-border flex items-start justify-center p-2 luminous-border">
          <motion.div
