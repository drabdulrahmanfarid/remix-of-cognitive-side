      ...
      <div className="relative z-10 text-center px-6 max-w-4xl mx-auto">
        <AnimatePresence>
          ...
          ease: [0.5, 0, 0, 1]
            ...
            repeat: Infinity,
            ease: "easeInOut"
          }} src="/lovable-uploads/7f9caa67-bdd1-4437-b231-df591030bf73.png" className="h-28 sm:h-36 md:h-44 w-auto mx-auto opacity-100 shadow-2xl border-none border-0 object-contain rounded-3xl" />
          </motion.div>
